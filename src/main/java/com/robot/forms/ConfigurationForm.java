...
public class ConfigurationForm {
    ...
    private void saveData() {
        try {
            ...
            anmPropertiesService.setProperty("timerWait", timerWait.getText());
    ...
    private void createUIComponents() {
        ...
        timerWait.setText(anmPropertiesService.getProperty("timerWait"));
    }

    private JPanel rootPanel;
    private JButton guardarButton;
    private JTextField timerWait;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setLayout(new GridLayoutManager(7, 3, new Insets(5, 5, 5, 5), -1, -1));
        ...
        timerWait = new JTextField();
        panel1.add(timerWait, new GridConstraints(6, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(-1, 20), new Dimension(381, 30), new Dimension(200, -1), 0, false));
        final JLabel label7 = new JLabel();
        label7.setText("Configuración General");
        rootPanel.add(label7, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
